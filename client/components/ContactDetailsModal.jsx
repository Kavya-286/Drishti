    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Provide your contact information so investors can reach out to you
            directly. This information will be shared with serious investors who
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Select
                  value={contactData.fundingStage}
                  onValueChange={(value) =>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleInputChange("shareDetails", checked)
                  }
                />
                <div className="grid gap-1.5 leading-none">
                  ...
                  <p className="text-xs text-muted-foreground">
                    ...
                    investors who express serious interest in your startup.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="grid gap-1.5 leading-none">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Get notified about relevant investors, funding
