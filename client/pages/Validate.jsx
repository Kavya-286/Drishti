...
import { validateStartupIdea, generateMockValidationResult } from '@shared/api';
...
export default function Validate() {
  ...
  const generateSuggestions = async (problemText) => {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>
                {currentStep === 1 && "Start by giving your startup a title and describing the problem you're solving"}
            ...
            <CardContent className="space-y-6">
              ...
              {currentStep === 1 && (
                <div className="space-y-6">
                  {/* NEW: Startup Title Field */}
                  <div>
                    <Label htmlFor="startupTitle">Startup Title/Name *</Label>
                    <p className="text-xs text-muted-foreground mb-2">
                      Give your startup idea a compelling name or title that captures its essence.
                    </p>
                    <Input
                      id="startupTitle"
                      placeholder="Example: InvenTrack, SmartInventory Pro, StockGenius..."
                      value={validationData.startupTitle}
                      onChange={(e) => updateData('startupTitle', e.target.value)}
                      className="mt-2"
                    />
                  </div>
