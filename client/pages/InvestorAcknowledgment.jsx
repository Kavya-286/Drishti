                ...
                <div>
                  ...
                  {startup.founder?.contactDetails ? (
                    <div className="mt-2 p-3 bg-green-50 rounded-lg border border-green-200">
                      <p className="text-xs text-green-800 mb-2"><strong>Contact Details Available:</strong></p>
                      <p className="text-xs"><strong>Email:</strong> {startup.founder.contactDetails.email}</p>
                      <p className="text-xs"><strong>Phone:</strong> {startup.founder.contactDetails.phone}</p>
                      <p className="text-xs"><strong>Preferred Contact:</strong> {startup.founder.contactDetails.preferredContact}</p>
                    </div>
                  ) : (
